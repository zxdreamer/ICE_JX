...
//char newssid[60] = "ZNJX-beijing";
//char newpass[60] = "313zzz313";
...
int wifi_set(char *newssid,char *newpass)
{
//	char newssid[] = "ZNJX-beijing";
//	char newpass[] = "313zzz313";

	config_t *myconf = confRead("/etc/hostapd/hostapd.conf");

	printf("ssid:'%s'\n", confGet(myconf, "ssid"));
	printf("pass:'%s'\n", confGet(myconf, "wpa_passphrase"));

	confSet(myconf, "ssid", newssid);
	confSet(myconf, "wpa_passphrase", newpass);
